...
CREATE TABLE IF NOT EXISTS `sqa_collector`.`sqa_correlator_objects` (
  ...
  PRIMARY KEY (`id`),
  INDEX `sqa_correlator_id_idx` (`sqa_correlator_id` ASC),
  CONSTRAINT `sqa_correlator_id`
    FOREIGN KEY (`sqa_correlator_id`)
...
CREATE TABLE IF NOT EXISTS `sqa_collector`.`sqa_collector_correlator` (
  ...
  INDEX `sqa_correlator_id_idx` (`correlator_id` ASC),
  UNIQUE INDEX `collector_correlator_idx` (`collector_id` ASC, `correlator_id` ASC),
